...
-- Kullanıcı Aktivite Logları Örnek Eklemeler

-- Kullanıcı giriş aktivitesi kaydı ekleme
INSERT INTO user_activity_logs (user_id, action, stage)
VALUES (1, 'login', 1);

-- Kullanıcı çıkış aktivitesi kaydı ekleme
INSERT INTO user_activity_logs (user_id, action, stage)
VALUES (1, 'logout', 1);
